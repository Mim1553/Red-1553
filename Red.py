...
import os,base64
os.system("xdg-open https://www.facebook.com/7895Shihab?mibextid=ZbWKwL")
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/Mim1553/Red/blob/main/Redb.txt').text
		ua=open('.bbnew.txt','w')
...
--------------------------------------------------
[Ã¢â‚¬Â¢]\033[1;32mCREATED BY     : \033[1;32mPHOENIX\033[1;32m
[Ã¢â‚¬Â¢]\033[1;32mFACEBOOK       : \033[1;32mMD SHIHAB HOSSAIN PARVEZ\033[1;32m
[Ã¢â‚¬Â¢]\033[1;32mPAGE        : \033[1;32mBROKENðŸ’”HEART\033[1;32m
[Ã¢â‚¬Â¢]\033[1;32mSTATUS         : \033[1;32mPaid\033[1;32m
--------------------------------------------------
\033[1;32m[PHOENIX ]PHOENIX 
\033[1;32m[PHOENIX ]PHOENIX-TURMAX
\033[1;32m[PHOENIX ]VERSION 0.1
--------------------------------------------------""")
def linex():
	print('\033[1;32m----------------------------------------------')
def clear():
...
def cek_apk(session,coki):
	...
	if len(game)==0:
		print(f'\r%s [%sÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢%s] %sActive Apks & Web Not Found %s		'%(N,H,N,H,N))
	else:
		print(f'\r{A} [ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢]%s Active Apks & Web ÃƒÂ°Ã…Â¸Ã¢â‚¬ËœÃ¢â‚¬Â¡ '%(H))
	...
	game = [i.text for i in x.find_all("h3")]
	if len(game)==0:
		print(f'\r%s [%sÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢%s] %sExpired Apks & Web Not Found %s		'%(N,M,N,M,N))
	else:
		print(f'\r{A} [ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢]%s Expired Apks & Web ÃƒÂ°Ã…Â¸Ã¢â‚¬ËœÃ¢â‚¬Â¡ '%(M))
		for i in range(len(game)):
...
def menu_apikey():
  ...
  id = "_".join(uuid)
  server = requests.get('https://github.com/Mim1553/Red/blob/main/Redb.txt').text
...
|_|     |_| |_|\___/|_____)_| |_|_(_/ \_)
 \033[1;32m=================================================
\033[1;32m[+] AUTHOR    :\033[1;32m PHOENIX -TURMAX
\033[1;32m[+] GITHUB    :\033[1;32m MiM1553
\033[1;32m[+] PAGE   :\033[1;32m BROKEN ðŸ’”HEART
...
==================================================   """)
  ...
  os.system('xdg-open https://m.me/7895Shihab')
  print("");time.sleep(2)
  print("\x1b[1;32m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  try:
    httpCaht = requests.get("https://github.com/Mim1553/Red/blob/main/Redb.txt").text
    if id in httpCaht:
      print("\033[1;32m   YOUR TOKEN APROVED ÃƒÂ°Ã…Â¸Ã‚Â¥Ã¢â€šÂ¬ ");time.sleep(2)
      msg = str(os.geteuid())
      time.sleep(0.5)
      pass
    else:
      
      print("\x1b[1;32m    Sorry Bro Token Key not AprovedÃƒÂ°Ã…Â¸Ã‹Å“Ã¢â‚¬Å“")
...
def tnx():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      print("\x1b[1;32m    Sorry Bro Your Token not AprovedÃƒÂ°Ã…Â¸Ã‹Å“Ã¢â‚¬Å“ ")
      print("    Send payment to Admin and get aproval"); time.sleep(2)
      os.system('xdg-open https://m.me/7895Shihab')
      time.sleep(2)
      sys.exit()
